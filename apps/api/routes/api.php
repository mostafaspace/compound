...
Route::prefix('v1')->name('api.v1.')->group(function (): void {
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        ...
        Route::apiResource('/apartments/{unit}/vehicles', ApartmentVehicleController::class)
            ->parameters(['vehicles' => 'vehicle'])
            ->only(['index', 'store', 'update', 'destroy'])
            ->names('apartments.vehicles');
        Route::apiResource('/apartments/{unit}/parking-spots', ApartmentParkingSpotController::class)
        ...
        Route::get('/admin/document-reviews', [AdminApartmentDocumentReviewController::class, 'index'])
